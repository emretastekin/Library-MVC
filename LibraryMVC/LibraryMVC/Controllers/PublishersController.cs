    ...
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Publishers != null ? 
                          ...
                          Problem("Entity set 'ApplicationContext.Publishers'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Phone,EMail,ContactPerson")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Phone,EMail,ContactPerson")] Publisher publisher)
        {
            if (id != publisher.Id)
            {
                return NotFound();
